...
test('catalog contains exactly the six bounded reviewed lanes', () => assert.deepStrictEqual(Registry.CATALOG.profiles.map((row) => row.id), ['code-family.bounded-css-token-stylesheet', 'code-family.bounded-javascript-record-transform', 'code-family.bounded-python-record-transform', 'code-family.json-schema-validator', 'code-family.static-html-page', 'code-family.svg-status-badge']));
